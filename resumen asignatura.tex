...
\subsection{Conclusiones}
\begin{itemize}
    \item Si no funciona algo no decirlo y continuar con normalidad.
    \item No apurar los márgenes en las presetaciones.
    \item Percepción selectiva - La presentación, su calidad visual, hace que el que recibe el contenido se predisponga, ejemplo de los exámenes y de una entrevista de trabajo en un banco. 
\end{itemize}
